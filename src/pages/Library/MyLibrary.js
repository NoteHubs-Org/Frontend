    ...
    <div className='library-container'>
      ...
      <div className='library-containers'>
        ...
        <div className="user-uploads">
          <Lib_Column docName={'Document 1'} docTitle={"document one"} type={"course"} />
          <Lib_Column docName={'Document 2'} docTitle={"document two"} type={"course"} />
        </div>
      ...
      <div className='library-containers'>
        <h2>My Questions</h2>
        <div className="user-uploads">
          <Lib_Column docName={'What is Osmoregulation 1'} docTitle={"Bsc. Microbiology"} type={"question"} />
          <Lib_Column docName={'Nursing Code ethics'} docTitle={"Bsc. Nursing"} type={"question"} />
          <Lib_Column docName={'Document 3'} docTitle={"document three"} type={"question"}/>
        </div>
